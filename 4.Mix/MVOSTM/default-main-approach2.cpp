...
{
	cout<<pl<<"MVOSTM Miner and Concurrent Validator - Approach2\n";
	cout<<"-----------------------------\n";
	...
	//		cout<<"\nAvg Grpah Time= "<<gConstT/nThread<<" microseconds";
			...
			int vAUs = gNodeCount;
			if(nBlock > 0)
				file_opr.writeOpt(input, nThread, numAUs, tTime,
				                  mTTime, vTTime, fvTTime, aCount,
				                  vAUs, mItrT, vItrT, fvItrT, 0);
