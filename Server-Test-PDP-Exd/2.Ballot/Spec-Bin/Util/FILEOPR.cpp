...
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!! getInp() reads #Proposals, #Voters, #Threads, !!!
!!! #AUs, & "Lemda" from input file               !!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
...
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!! writeOpt() stores the Time taken by algorithm in output file "Time.csv"  !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
void FILEOPR::writeOpt(int nProposal, int nVoter, 
                       int nThreads, int nAUs, float TTime[], 
                       float_t mTTime[], float_t vTTime[],
                       int aCount[], int vAUs, 
                       list<float>&mIT, list<float>&vIT, bool vtype)
{
	ofstream out;
	int n = nThreads;
