...
double tTime[3];           //! total time taken by miner and validator algorithm.
...
//		cGraph->print_grpah2(cGraph); //! print conflict grpah generated by miner.
//		FILEOPR file_opr;
...
//						cb.unlock();
		...
		mTTime[t_ID] += Ttimer._timeStop( start );
	}
...
{
	cout<<pl<<"BTO Miner and Concurrent Validator - Approach 1\n";
	cout<<"--------------------------------\n";
